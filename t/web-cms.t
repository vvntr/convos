...
$t->get_ok('/doc/Convos/Core')->status_is(200)->header_is('X-Provider-Name', undef)
  ...
  ->element_exists(qq(meta[name="convos:start"][content=""]))
...
$t->get_ok('/')->status_is(200)->header_is('X-Provider-Name', 'ConvosApp')
  ->element_exists(qq(meta[name="convos:start"][content="chat"]))->element_exists('.hero');
...
$t->get_ok('/')->status_is(200)->header_is('X-Provider-Name', undef)
  ->element_exists(qq(meta[name="convos:start"][content=""]))->element_exists('body.for-cms')
...
$t->get_ok('/blog/2020/5/17/too-cool.html')->status_is(200)->header_is('X-Provider-Name', undef)
  ...
  ->element_exists(qq(meta[name="convos:start"][content=""]))->text_is('h1', 'Cool heading')
